...
import kotlinx.android.synthetic.main.activity_out_stagram_upload_activty.*
...
class OutStagramUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_out_stagram_upload_activty)
        ...
        (application as MasterApplication).service.uploadPost(
            ...
            override fun onResponse(call: Call<Post>, response: Response<Post>) {
                if (response.isSuccessful) {
                    ...
                    startActivity(
                        Intent(
                            this@OutStagramUploadActivity,OutstargramMyPostListActivity::class.java
                        )
                    )
                }
            }
